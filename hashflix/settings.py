...
if TOKEN_CSRF:
    ...
    CSRF_TRUSTED_ORIGINS = ['https://projetohashflixdjango-production-661f.up.railway.app']
else:
...
ALLOWED_HOSTS = ["projetohashflixdjango-production-661f.up.railway.app", "localhost", "127.0.0.1"]
