...
if TOKEN_CSRF:
    ...
    CSRF_TRUSTED_ORIGINS = ['https://projetohashflixdjango-production-0eb7.up.railway.app']
else:
...
ALLOWED_HOSTS = ["projetohashflixdjango-production-0eb7.up.railway.app", "localhost", "127.0.0.1"]
