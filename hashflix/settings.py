...
if TOKEN_CSRF:
    ...
    CSRF_TRUSTED_ORIGINS = ['https://projetohashflixdjango-production-30e4.up.railway.app/']
else:
...
ALLOWED_HOSTS = ["https://projetohashflixdjango-production-30e4.up.railway.app/", "localhost", "127.0.0.1"]
